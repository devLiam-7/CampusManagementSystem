...
import ui.AddTimetableFrame;

public class Timetable extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Timetable.class.getName());
    ...
    private void initComponents() {
        ...
        jButton1.setText("Add TimeTable");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new AddTimetableFrame().setVisible(true);
        this.dispose();
